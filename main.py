...
if __name__ == "__main__":
    ...
    p.add_argument('--face-type', dest="face_type", choices=['half_face', 'full_face', 'full_face_no_align', 'head', 'head_no_align', 'mark_only'], default='full_face', help="Default 'full_face'. Don't change this option, currently all models uses 'full_face'")
